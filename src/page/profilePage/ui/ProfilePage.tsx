...
export const ProfilePage: FC = () => {
  ...
  const onChangeString = useCallback(
    (nameField: string) => (value: string) => {
      dispatch(
        profileActions.setStringProfile({
          [nameField]: validate.string(value),
        })
      );
    },
    []
  ...
  const onChangeNumber = useCallback(
    (nameField: string) => (value: string) => {
      dispatch(
        profileActions.setStringProfile({
          [nameField]: validate.number(value),
        })
      );
    },
    []
  ...
  const onChangeNoValid = useCallback(
    (nameField: string) => (value: string) => {
